...
Definition mux_mut_refs_u64__tuple_fun : @CompM.lrtTupleType (@CompM.LRT_Cons (@CompM.LRT_Fun (forall (ps : prod (@sigT (@SAWCorePrelude.bitvector 64) (fun (x_ex0 : @SAWCorePrelude.bitvector 64) => unit)) (prod (@sigT (@SAWCorePrelude.bitvector 64) (fun (x_ex0 : @SAWCorePrelude.bitvector 64) => unit)) unit)), let var__0   := @SAWCorePrelude.bitvector 64 in
  ...
  proveEq: Could not prove W = (). R"%string)) tt).
...
Definition use_mux_mut_refs__tuple_fun : @CompM.lrtTupleType (@CompM.LRT_Cons (@CompM.LRT_Ret (@sigT (@SAWCorePrelude.bitvector 64) (fun (x_ex0 : @SAWCorePrelude.bitvector 64) => unit))) (@CompM.LRT_Nil)) :=
  ...
  let var__1   := @sigT var__0 (fun (x_ex0 : var__0) => unit) in
  CompM (prod var__1 (prod var__1 unit))) (prod (@sigT (@SAWCorePrelude.bitvector 64) (fun (x_ex0 : @SAWCorePrelude.bitvector 64) => unit)) unit)) (@sigT (@SAWCorePrelude.bitvector 64) (fun (x_ex0 : @SAWCorePrelude.bitvector 64) => unit)) (@mux_mut_refs_u64 (@SAWCorePrelude.composeM (prod (@sigT (@SAWCorePrelude.bitvector 64) (fun (x_ex0 : @SAWCorePrelude.bitvector 64) => unit)) (prod (@sigT (@SAWCorePrelude.bitvector 64) (fun (x_ex0 : @SAWCorePrelude.bitvector 64) => unit)) unit)) unit (prod (@sigT (@SAWCorePrelude.bitvector 64) (fun (x_ex0 : @SAWCorePrelude.bitvector 64) => unit)) (prod (@sigT (@SAWCorePrelude.bitvector 64) (fun (x_ex0 : @SAWCorePrelude.bitvector 64) => unit)) unit)) (fun (x_local0 : prod (@sigT (@SAWCorePrelude.bitvector 64) (fun (x_ex0 : @SAWCorePrelude.bitvector 64) => unit)) (prod (@sigT (@SAWCorePrelude.bitvector 64) (fun (x_ex0 : @SAWCorePrelude.bitvector 64) => unit)) unit)) => @errorM CompM _ unit "Error mapping lifetime input perms:

  proveEq: Could not prove LLVMword z20 = (). x7"%string) (@SAWCorePrelude.composeM unit unit (prod (@sigT (@SAWCorePrelude.bitvector 64) (fun (x_ex0 : @SAWCorePrelude.bitvector 64) => unit)) (prod (@sigT (@SAWCorePrelude.bitvector 64) (fun (x_ex0 : @SAWCorePrelude.bitvector 64) => unit)) unit)) (fun (ps_empty : unit) => @returnM CompM _ unit ps_empty) (fun (x_local0 : unit) => @errorM CompM _ (prod (@sigT (@SAWCorePrelude.bitvector 64) (fun (x_ex0 : @SAWCorePrelude.bitvector 64) => unit)) (prod (@sigT (@SAWCorePrelude.bitvector 64) (fun (x_ex0 : @SAWCorePrelude.bitvector 64) => unit)) unit)) "Error mapping lifetime output perms:

  proveEq: Could not prove x11 = (z19). LLVMword z19"%string))) (@existT (@SAWCorePrelude.bitvector 64) (fun (x_ex0 : @SAWCorePrelude.bitvector 64) => unit) (intToBv 64 5%Z) tt) (@existT (@SAWCorePrelude.bitvector 64) (fun (x_ex0 : @SAWCorePrelude.bitvector 64) => unit) (intToBv 64 0x2a%Z) tt) (@existT (@SAWCorePrelude.bitvector 1) (fun (x_ex0 : @SAWCorePrelude.bitvector 1) => unit) (intToBv 1 (-1)%Z) tt)) (fun (call_ret_val : prod (forall (ps : prod (@sigT (@SAWCorePrelude.bitvector 64) (fun (x_ex0 : @SAWCorePrelude.bitvector 64) => unit)) unit), let var__0   := @SAWCorePrelude.bitvector 64 in
  let var__1   := @sigT var__0 (fun (x_ex0 : var__0) => unit) in
  ...
  "%string else @errorM CompM _ (@sigT (@SAWCorePrelude.bitvector 64) (fun (x_ex0 : @SAWCorePrelude.bitvector 64) => unit)) "At internal ($4 = load llvm_memory $0 bitvectorType 8 Alignment 3)
  Regs: $0 = local1
  Input perms: ghost4:llvmframe [local1:8, ghost9:8], local1:true,
               ghost9:true
  Could not prove (z13, z12, z11). local1:[z12]ptr((z13,0) |->
                                                     eq(z11))

  proveVarAtomicImpl: Could not prove
  local1:true -o (z13, z12, z11). [z12]ptr((z13,0) |-> eq(z11))"%string))))) tt).
