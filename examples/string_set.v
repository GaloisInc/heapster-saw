...
Definition string_set_insert : forall (p0 : ((@string_set))), forall (p1 : ((@SAWCoreScaffolding.String))), ((CompM) (((@sigT) (unit) ((fun (ret0 : unit) => ((@string_set))))))) :=
  ((@listInsertM) (((@SAWCoreScaffolding.String)))).

Definition string_set_remove : forall (p0 : ((@string_set))), forall (p1 : ((@SAWCoreScaffolding.String))), ((CompM) (((@sigT) (unit) ((fun (ret0 : unit) => ((prod) (((@string_set))) (((prod) (((@SAWCoreScaffolding.String))) (unit))))))))) :=
  ((@listRemoveM) (((@SAWCoreScaffolding.String))) (((@SAWCoreScaffolding.equalString)))).

Definition insert_remove__tuple_fun : ((@CompM.lrtTupleType) (((@CompM.LRT_Cons) (((@CompM.LRT_Fun) (((@string_set))) ((fun (perm0 : ((@string_set))) => ((@CompM.LRT_Fun) (((@SAWCoreScaffolding.String))) ((fun (perm1 : ((@SAWCoreScaffolding.String))) => ((@CompM.LRT_Fun) (((@SAWCoreScaffolding.String))) ((fun (perm2 : ((@SAWCoreScaffolding.String))) => ((@CompM.LRT_Ret) (((@sigT) (unit) ((fun (ret0 : unit) => ((prod) (((@string_set))) (((prod) (((@SAWCoreScaffolding.String))) (unit))))))))))))))))))) (((@CompM.LRT_Nil)))))) :=
  ((@CompM.multiFixM) (((@CompM.LRT_Cons) (((@CompM.LRT_Fun) (((@string_set))) ((fun (perm0 : ((@string_set))) => ((@CompM.LRT_Fun) (((@SAWCoreScaffolding.String))) ((fun (perm1 : ((@SAWCoreScaffolding.String))) => ((@CompM.LRT_Fun) (((@SAWCoreScaffolding.String))) ((fun (perm2 : ((@SAWCoreScaffolding.String))) => ((@CompM.LRT_Ret) (((@sigT) (unit) ((fun (ret0 : unit) => ((prod) (((@string_set))) (((prod) (((@SAWCoreScaffolding.String))) (unit))))))))))))))))))) (((@CompM.LRT_Nil))))) ((fun (insert_remove : ((@CompM.lrtToType) (((@CompM.LRT_Fun) (((@string_set))) ((fun (perm0 : ((@string_set))) => ((@CompM.LRT_Fun) (((@SAWCoreScaffolding.String))) ((fun (perm1 : ((@SAWCoreScaffolding.String))) => ((@CompM.LRT_Fun) (((@SAWCoreScaffolding.String))) ((fun (perm2 : ((@SAWCoreScaffolding.String))) => ((@CompM.LRT_Ret) (((@sigT) (unit) ((fun (ret0 : unit) => ((prod) (((@string_set))) (((prod) (((@SAWCoreScaffolding.String))) (unit))))))))))))))))))))) => ((pair) ((fun (p0 : ((@string_set))) (p1 : ((@SAWCoreScaffolding.String))) (p2 : ((@SAWCoreScaffolding.String))) => ((@CompM.letRecM) (((@CompM.LRT_Nil))) (((@sigT) (unit) ((fun (ret0 : unit) => ((prod) (((@string_set))) (((prod) (((@SAWCoreScaffolding.String))) (unit)))))))) (tt) (((((@bindM) (CompM) (_))) (((@sigT) (unit) ((fun (ret0 : unit) => ((@string_set)))))) (((@sigT) (unit) ((fun (ret0 : unit) => ((prod) (((@string_set))) (((prod) (((@SAWCoreScaffolding.String))) (unit)))))))) (((@string_set_insert) (p0) (p1))) ((fun (call_ret_val : ((@sigT) (unit) ((fun (ret0 : unit) => ((@string_set)))))) => ((((@bindM) (CompM) (_))) (((@sigT) (unit) ((fun (ret0 : unit) => ((prod) (((@string_set))) (((prod) (((@SAWCoreScaffolding.String))) (unit)))))))) (((@sigT) (unit) ((fun (ret0 : unit) => ((prod) (((@string_set))) (((prod) (((@SAWCoreScaffolding.String))) (unit)))))))) (((@string_set_remove) (((@projT2) (unit) ((fun (elim_call_ret_val0 : unit) => ((@string_set)))) (call_ret_val))) (p2))) ((fun (call_ret_val : ((@sigT) (unit) ((fun (ret0 : unit) => ((prod) (((@string_set))) (((prod) (((@SAWCoreScaffolding.String))) (unit)))))))) => ((((@returnM) (CompM) (_))) (((@sigT) (unit) ((fun (ret0 : unit) => ((prod) (((@string_set))) (((prod) (((@SAWCoreScaffolding.String))) (unit)))))))) (((@existT) (unit) ((fun (r0 : unit) => ((prod) (((@string_set))) (((prod) (((@SAWCoreScaffolding.String))) (unit)))))) (tt) (((pair) (((SAWCoreScaffolding.fst) (((@projT2) (unit) ((fun (elim_call_ret_val0 : unit) => ((prod) (((@string_set))) (((prod) (((@SAWCoreScaffolding.String))) (unit)))))) (call_ret_val))))) (((pair) (((SAWCoreScaffolding.fst) (((SAWCoreScaffolding.snd) (((@projT2) (unit) ((fun (elim_call_ret_val0 : unit) => ((prod) (((@string_set))) (((prod) (((@SAWCoreScaffolding.String))) (unit)))))) (call_ret_val))))))) (tt)))))))))))))))))) (tt))))).

Definition insert_remove : ((@CompM.lrtToType) (((@CompM.LRT_Fun) (((@string_set))) ((fun (perm0 : ((@string_set))) => ((@CompM.LRT_Fun) (((@SAWCoreScaffolding.String))) ((fun (perm1 : ((@SAWCoreScaffolding.String))) => ((@CompM.LRT_Fun) (((@SAWCoreScaffolding.String))) ((fun (perm2 : ((@SAWCoreScaffolding.String))) => ((@CompM.LRT_Ret) (((@sigT) (unit) ((fun (ret0 : unit) => ((prod) (((@string_set))) (((prod) (((@SAWCoreScaffolding.String))) (unit)))))))))))))))))))) :=
