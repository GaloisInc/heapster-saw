...
Proof.
  ...
  * rewrite <- isBvult_to_isBvslt_pos, e_assuming5 in e_assuming6; try assumption.
    rewrite e_assuming6 in e_maybe.
    discriminate e_maybe.
  * rewrite e_assuming7.
    apply isBvsle_suc_r.
    rewrite e_assuming8, e_assuming4.
    reflexivity.
  * rewrite <- e_assuming10 in e_if.
    apply isBvslt_to_isBvsle_suc, isBvult_to_isBvslt_pos; assumption.
  * rewrite <- e_assuming7 in e_if0.
    vm_compute in e_if0; inversion e_if0.
  * rewrite e_assuming8, e_assuming4 in e_if0.
    vm_compute in e_if0; inversion e_if0.
  * rewrite <- e_assuming3 in e_if0.
    vm_compute in e_if0; inversion e_if0.
  * rewrite e_assuming6, e_assuming2 in e_if0.
    vm_compute in e_if0; inversion e_if0.
  * rewrite e_assuming3.
